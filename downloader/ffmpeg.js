        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                ...
                ffmpeg.stdout.on("data", function (data) {
                    return console.log("ffmpeg stdout: " + data);
                });
                ffmpeg.stderr.on("data", function (data) {
                    return console.log("ffmpeg stderr: " + data);
                });
            })];
        });
    });
...
function mergeChunks(segments, outputFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    segmentsFile = "ffmpeg-input.txt";
                    inputStr = segments.map(function (f) {
                        return "file '" + f + "'\n";
                    }).join("");
                    ...
                    return [4 /*yield*/, spawnFfmpeg(mergeArgs)];
                case 1:
                    _a.sent();
